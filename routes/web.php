...
Route::get('/index', 'FrontEndController@index')->name('front');
Route::get('/', function(){
return view ('Nafees.index');
});
...
Route::get('aboutus',function(){
    return view('Nafees.aboutus');
});
Route::get('franchising-3',function(){
    return view('Nafees.franchising-3');
});
Route::get('news',function(){
    return view('Nafees.news');
});
Route::get('vacancies',function(){
    return view('Nafees.vacancies');
});
Route::get('contact',function(){
    return view('Nafees.contact');
});
Route::get('franchising-3',function(){
    return view('Nafees.franchising-3');
});
