                            ...
                            <form method="post" action="<?php echo e(route('items.update', $item)); ?>" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo $__env->make('partials.toggle',['id'=>'sell','name'=>'Sell online','checked'=>($item->sell==1)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\foodtiger\resources\views/items/edit.blade.php ENDPATH**/ ?>