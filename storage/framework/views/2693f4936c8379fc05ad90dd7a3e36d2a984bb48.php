...
<div id="page" class="page">
  ...
  <header data-bully id="post-37-title" class="c-hero  article__header  article__header--page two-thirds-height" data-type="image">
							...
							<img class="c-hero__image" data-rellax src="<?php echo e(asset('Nafees/Images/imgp8441_2.jpg')); ?>" alt="Stores"/>
						</div>
    ...
    flex-basis: 100%;
          ...
          <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="grid-item">
              ...
              <a class="wrapping-link" href="restaurant/<?php echo e($store['subdomain']); ?>" ></a>	   
              <div class="grid-item-wrapper">
                <div class="grid-item-container">
                  <div class="grid-image-top sputnik" style="background-image: url('<?php echo e($store->icon); ?>');">
                   
                  </div>
                  <div class="grid-item-content">
                    <h2 class="item-title"><?php echo e($store['name']); ?></h2>
                    <span class="font-weight-bolder" >Address:</span>
                    <span ><?php echo e($store['address']); ?></span>
                    <h5><span class="font-weight-bolder">TEL <a href="tel://0343"><?php echo e($store['phone']); ?></a></span></h5>
                  </div>
                </div>
              </div>
            </div>
...
</html><?php /**PATH D:\Projects\foodtiger\resources\views/Nafees/stores.blade.php ENDPATH**/ ?>